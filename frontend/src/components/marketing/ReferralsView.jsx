  ...
  return (
    <div className="space-y-6">
      <div className="space-y-3">
        <h3 className="font-bold text-gray-900">Find Referral Code</h3>
        ...
        {referral && (
          <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl text-center">
            <p className="text-xs text-emerald-700 mb-1">Customer {referral.customer_id}'s Code</p>
            <p className="text-2xl font-mono font-black text-emerald-900">{referral.code}</p>
            <p className="text-xs text-emerald-600 mt-2 font-bold">{referral.times_used} successful referrals</p>
          </div>
        )}
      </div>

      <div className="pt-4 border-t space-y-3">
        <h3 className="font-bold text-gray-900">Redeem a Code</h3>
