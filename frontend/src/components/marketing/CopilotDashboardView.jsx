    ...
    <div className="space-y-6">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex items-center gap-6">
              <button 
                ...
                disabled={generating}
                className="bg-panel dark:bg-panel-dark text-inkA dark:text-inkA-dark px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-lg"
              >
      ...
      {generatedCampaign && (
        <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/25 rounded-3xl p-6 relative">
          <button onClick={() => setGeneratedCampaign(null)} className="absolute top-4 right-4 text-gray-400 dark:text-slate-500 hover:text-gray-600">×</button>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-emerald-700 dark:text-emerald-400">{generatedCampaign.name}</p>
            </div>
          </div>
          <div className="bg-panel dark:bg-panel-dark rounded-2xl p-4 border border-emerald-200 dark:border-emerald-500/25 shadow-sm mb-4">
            <h4 className="text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-widest mb-2">Message Draft (WhatsApp)</h4>
            <p className="text-sm font-medium text-inkA dark:text-inkA-dark">"{generatedCampaign.ai_content?.whatsappMessage || generatedCampaign.ai_content?.whatsapp || 'Drafted message...'}"</p>
          </div>
          ...
          {insights.vip && (
            <div className="mb-3 p-3 bg-blue-50 dark:bg-blue-500/10 rounded-xl border border-blue-200 dark:border-blue-500/25">
              ...
              <button 
                ...
                className="text-[10px] font-bold bg-panel dark:bg-panel-dark text-blue-700 dark:text-blue-400 px-3 py-1.5 rounded-lg shadow-sm w-full text-left flex justify-between items-center"
              >
          ...
          {insights.atRisk && (
            <div className="p-3 bg-red-50 dark:bg-red-500/10 rounded-xl border border-red-200 dark:border-red-500/25">
              ...
              <button 
                ...
                className="text-[10px] font-bold bg-panel dark:bg-panel-dark text-red-700 dark:text-red-400 px-3 py-1.5 rounded-lg shadow-sm w-full text-left flex justify-between items-center"
              >
          ...
          {opportunities.map((opp, i) => (
            <div key={i} className="mb-3 last:mb-0 p-3 bg-orange-50 dark:bg-orange-500/10 rounded-xl border border-orange-200 dark:border-orange-500/25 flex flex-col gap-2">
              ...
              <button 
                ...
                className="text-[10px] font-bold bg-panel dark:bg-panel-dark text-orange-700 dark:text-orange-400 px-3 py-1.5 rounded-lg shadow-sm w-full text-left flex justify-between items-center"
              >
          ...
          {calendar.map((ev, i) => (
            <div key={i} className="mb-3 last:mb-0 p-3 bg-violet-50 dark:bg-violet-500/10 rounded-xl border border-violet-200 dark:border-violet-500/25">
              ...
              <button 
                ...
                className="text-[10px] font-bold bg-panel dark:bg-panel-dark text-violet-700 dark:text-violet-400 px-3 py-1.5 rounded-lg shadow-sm w-full text-left mt-2 flex justify-between items-center"
              >
