...
const BUSINESS_TYPES = [
  { id: 'grocery', label: 'Grocery / Kirana', icon: ShoppingBag, color: 'text-green-500 dark:text-green-400' },
  { id: 'clothing', label: 'Clothing Store', icon: Store, color: 'text-pink-500 dark:text-pink-400' },
  { id: 'pharmacy', label: 'Pharmacy', icon: Activity, color: 'text-red-500 dark:text-red-400' },
  { id: 'electronics', label: 'Electronics', icon: Monitor, color: 'text-blue-500 dark:text-blue-400' },
  { id: 'restaurant', label: 'Restaurant', icon: Utensils, color: 'text-orange-500 dark:text-orange-400' },
  { id: 'bakery', label: 'Bakery', icon: Coffee, color: 'text-amber-500 dark:text-amber-400' },
  { id: 'hardware', label: 'Hardware', icon: Wrench, color: 'text-inkB dark:text-inkB-dark' },
  { id: 'mobile', label: 'Mobile Shop', icon: Smartphone, color: 'text-cyan-500 dark:text-cyan-400' },
  { id: 'stationery', label: 'Stationery', icon: BookOpen, color: 'text-purple-500 dark:text-purple-400' },
  { id: 'others', label: 'Others', icon: Layers, color: 'text-indigo-500 dark:text-indigo-400' },
];
...
export default function BusinessSelection({ onNavigate }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-panel dark:bg-panel-dark font-sans p-6 relative overflow-hidden">
        ...
        <div className="bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl space-y-6">
            ...
            {BUSINESS_TYPES.map((type) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-inkA dark:text-inkA-dark group-hover:text-inkA dark:hover:text-white text-center">
                    {type.label}
                  </span>
                </button>
              );
          ...
          <div className="pt-4 text-center">
            <button
              ...
              className="text-xs text-inkB dark:text-inkB-dark hover:text-blue-400 font-medium transition-colors underline decoration-transparent hover:decoration-blue-400/30 underline-offset-4"
            >
